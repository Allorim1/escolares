 ...
 */
router.get('/', (req, res) => lineas_controller_1.lineasController.getAll(req, res));
/**
 * @swagger
 * /api/lineas/{id}:
 *   get:
 ...
 */
router.get('/:id', (req, res) => lineas_controller_1.lineasController.getById(req, res));
/**
 * @swagger
 * /api/lineas:
 *   post:
 ...
 */
router.post('/', (req, res) => lineas_controller_1.lineasController.create(req, res));
/**
 * @swagger
 * /api/lineas/{id}:
 *   put:
 ...
 *         description: Línea no encontrada
 */
router.put('/:id', (req, res) => lineas_controller_1.lineasController.update(req, res));
/**
 * @swagger
 * /api/lineas/{id}:
 *   delete:
 ...
 */
router.delete('/:id', (req, res) => lineas_controller_1.lineasController.delete(req, res));
/**
 * @swagger
 ...
 */
router.post('/:id/products', (req, res) => lineas_controller_1.lineasController.addProduct(req, res));
/**
 * @swagger
 * /api/lineas/{id}/products:
 *   delete:
 ...
 */
router.delete('/:id/products', (req, res) => lineas_controller_1.lineasController.removeProduct(req, res));
